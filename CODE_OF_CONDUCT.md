...
- **Being respectful**: different viewpoints and experiences are valuable
- **Being constructive**: focus on what is best for the project, and give
  and gracefully accept constructive feedback
- **Being collaborative**: work together towards common goals
- **Being patient**: we all have different levels of experience
...
[Issues](https://github.com/fbuireu/fbuireu-cli/issues) and
[Pull Requests](https://github.com/fbuireu/fbuireu-cli/pulls), and also
...
- **Privacy**: the reporter's identity and the details of the report will be
  kept confidential
